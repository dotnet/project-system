...
FOR /F "USEBACKQ delims=" %%i IN (`powershell -NonInteractive -NoLogo -NoProfile -Command "([xml](Get-Content %~dp0\..\imports\Versions.props)).Project.PropertyGroup.MinimumRequiredVSVersion"`) DO SET RequiredVSVersion=%%i
