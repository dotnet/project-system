...
namespace Microsoft.VisualStudio.ProjectSystem.Properties.InterceptedProjectProperties.PackagePropertyPage
{
    public class PackageFilePropertyValueProviderBaseTests
    {
        ...
        public async Task GetPackageLicenseKind(string include, string pack, string packagePath, string expectedValue)
        {
            ...
            await projectItemProvider.AddAsync(None.SchemaName, include, );
