...
{
    public sealed class HierarchyItemFlagsDetectorTests
    {
        [Fact]
        public void Matches_ThrowsWhenNullString()
        {
            var detector = new HierarchyItemFlagsDetector(ProjectTreeFlags.Empty);
        ...
        {
            var detector = new HierarchyItemFlagsDetector(ProjectTreeFlags.Create("APPLE"));
        ...
        {
            var detector = new HierarchyItemFlagsDetector(ProjectTreeFlags.Create("APPLE"), RegexOptions.IgnoreCase);
        ...
        {
            var detector = new HierarchyItemFlagsDetector(ProjectTreeFlags.Create("APPLE") + ProjectTreeFlags.Create("BANANA"));
