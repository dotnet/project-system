    ...
    Friend MustInherit Class ResourceTypeEditorInternalBase
        ...
        Protected Shared Sub SaveFileFromManifestResource(ManifestResourceId As String, FilePath As String)
            ...
            Else
                ...
                Throw New InternalException(My.Resources.Designer.RSE_Err_Unexpected_NoResource_1Arg)
            End If
        End Sub
        ...
        Public Overrides Function IsResourceItemValid(NewResource As IResource, ResourceContentFile As IResourceContentFile, ByRef Message As String, ByRef HelpID As String) As Boolean
            If ResourceContentFile.IsInsideDeviceProject Then
                ...
                If String.Equals(typeName, GetType(MemoryStream).FullName, StringComparison.Ordinal) Then
                    Message = My.Resources.Designer.GetString(My.Resources.Designer.RSE_Err_TypeIsNotSupported_1Arg, GetType(UnmanagedMemoryStream).Name)
