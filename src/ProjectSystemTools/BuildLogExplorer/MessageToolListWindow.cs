...
namespace Microsoft.VisualStudio.ProjectSystem.Tools.BuildLogExplorer
{
    ...
    internal sealed class MessageListToolWindow : TableToolWindow, IVsSelectionEvents
    {
        ...
        public readonly Guid MessageListToolWindowGuid = new Guid(MessageListToolWindowGuidString);
        ...
        private static readonly IReadOnlyList<string> ErrorStrings = new[] { BuildLogExplorerResources.ErrorsCategory, BuildLogExplorerResources.ErrorActiveCategory, BuildLogExplorerResources.ErrorInactiveCategory };
        private static readonly IReadOnlyList<string> WarningStrings = new[] { BuildLogExplorerResources.WarningsCategory, BuildLogExplorerResources.WarningActiveCategory, BuildLogExplorerResources.WarningInactiveCategory };
        private static readonly IReadOnlyList<string> MessageStrings = new[] { BuildLogExplorerResources.MessagesCategory, BuildLogExplorerResources.MessageActiveCategory, BuildLogExplorerResources.MessageInactiveCategory };
        ...
        protected override string SearchWatermark => BuildLogExplorerResources.MessageListSearchWatermark;

        protected override string WindowCaption => BuildLogExplorerResources.MessageListWindowTitle;
        ...
        private void UpdateLabels(int totalErrors, int visibleErrors, int totalWarnings, int visibleWarnings, int totalMessages, int visibleMessages)
        {
            var newErrorsLabel = string.Format(CultureInfo.InvariantCulture,
                                                  totalErrors == visibleErrors ? BuildLogExplorerResources.SameLabel : BuildLogExplorerResources.DifferentLabel,
                                                  totalErrors == 1 ? BuildLogExplorerResources.ErrorLabel : BuildLogExplorerResources.ErrorsLabel, visibleErrors, totalErrors);

            var newWarningsLabel = string.Format(CultureInfo.InvariantCulture,
                                                    totalWarnings == visibleWarnings ? BuildLogExplorerResources.SameLabel : BuildLogExplorerResources.DifferentLabel,
                                                    totalWarnings == 1 ? BuildLogExplorerResources.WarningLabel : BuildLogExplorerResources.WarningsLabel, visibleWarnings, totalWarnings);

            var newMessagesLabel = string.Format(CultureInfo.InvariantCulture,
                                                    totalMessages == visibleMessages ? BuildLogExplorerResources.SameLabel : BuildLogExplorerResources.DifferentLabel,
                                                    totalMessages == 1 ? BuildLogExplorerResources.MessageLabel : BuildLogExplorerResources.MessagesLabel, visibleMessages, totalMessages);
