...
namespace Microsoft.VisualStudio.Editors.UnitTests.Mocks
{
    ...
    public class ProjectFake : Project
    {
        ...
        public ProjectItems Fake_projectItems = new ProjectItemsFake("WindowsApplication1");
        public string Fake_fullName = @"c:\temp\WindowsApplication1\WindowsApplication1.vbproj";
