...
namespace Microsoft.VisualStudio.Editors.PropertyPages.WPF
{
    ...
    public class AppDotXamlDocumentTests
    {
        ...
        {
            Assert.AreEqual("lt&lt;, gr&gt;, squote&apos;, dquote&quot;, equals=, tab\t, esszet�",
                AppDotXamlDocument.EscapeXmlString("lt<, gr>, squote', dquote\", equals=, tab\t, esszet�"));
        }
        ...
        {
            Assert.AreEqual("lt<, gr>, squote', dquote\", equals=, tab\t, esszet�",
                AppDotXamlDocument.UnescapeXmlContent("lt&lt;, gr&gt;, squote&apos;, dquote&quot;, equals=, tab\t, esszet�"));
        }

        [TestMethod]
        public void UnescapeXmlContent_CDATA()
        {
            Assert.AreEqual("'R�ksm�rg�s' \"hi\".xaml",
                AppDotXamlDocument.UnescapeXmlContent("'R�k<![CDATA[sm�rg]]>�s' \"hi&quot;.xaml"));
        }
        ...
        public void GetStartupUri_PropertyElementSyntax_CDATA1()
        {
            string text =
                string.Join("\r\n", new string[] {
                    "<Application ",
                    "xmlns=\"http://schemas.microsoft.com/winfx/2006/xaml/presentation\" xmlns:x=\"http://schemas.microsoft.com/winfx/2006/xaml\">",
                    "  <Application.StartupUri>R�k<![CDATA[sm�rg]]>�s.xaml</Application.StartupUri>",
                    "  <Application.MainWindow>",
                    "  <NavigationWindow Source=\"MainPage.xaml\" Visibility=\"Visible\"></NavigationWindow> </Application.MainWindow>",
                    "</Application>"});
            using (VsTextBufferFake buffer = new VsTextBufferFake(text))
            {
                using (AppDotXamlDocument xamlReader = new AppDotXamlDocument(buffer))
                {
                    ...
                    Assert.AreEqual("R�ksm�rg�s.xaml", value);
                }
            }
        }
        ...
        public void GetStartupUri_PropertyElementSyntax_CDATA2()
        {
            string text =
                string.Join("\r\n", new string[] {
                    "<Application ",
                    "xmlns=\"http://schemas.microsoft.com/winfx/2006/xaml/presentation\" xmlns:x=\"http://schemas.microsoft.com/winfx/2006/xaml\">",
                    "  <Application.StartupUri><![CDATA[sm�rg]]></Application.StartupUri>",
                    "  <Application.MainWindow>",
                    "  <NavigationWindow Source=\"MainPage.xaml\" Visibility=\"Visible\"></NavigationWindow> </Application.MainWindow>",
                    "</Application>"});
            using (VsTextBufferFake buffer = new VsTextBufferFake(text))
        ...
        public void GetStartupUri_PropertyElementSyntax_CDATA3()
        {
            string text =
                string.Join("\r\n", new string[] {
                    ...
                    "xmlns=\"http://schemas.microsoft.com/winfx/2006/xaml/presentation\" xmlns:x=\"http://schemas.microsoft.com/winfx/2006/xaml\">",
                    "  <Application.StartupUri>",
                    "<![CDATA[sm�rg]]></Application.StartupUri>",
                    "  <Application.MainWindow>",
                    "  <NavigationWindow Source=\"MainPage.xaml\" Visibility=\"Visible\"></NavigationWindow> </Application.MainWindow>",
                    "</Application>"});
            using (VsTextBufferFake buffer = new VsTextBufferFake(text))
        ...
        public void SetStartupUri_PropertyElementSyntax_CDATA()
        {
            Test_SetStartupUri(
                string.Join("\r\n", new string[] {
                    ...
                    "</Application>"}),
                "R�ksm�rg�s.xaml",
                "What's a R�ksm�rg�s, anyway?.xaml",
                string.Join("\r\n", new string[] {
                    "<Application xmlns='http://schemas.microsoft.com/presentation' xmlns:x='http://schemas.microsoft.com/xaml'>",
                    "  <Application.StartupUri>What&apos;s a R�ksm�rg�s, anyway?.xaml</Application.StartupUri>",
                    "</Application>"})
            );
        }
