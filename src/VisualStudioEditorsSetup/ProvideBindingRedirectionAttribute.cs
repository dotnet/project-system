...
namespace Microsoft.VisualStudio
{
    ...
    internal sealed class ProvideEditorsBindingRedirectionAttribute : RegistrationAttribute
    {
        private readonly ProvideBindingRedirectionAttribute _redirectionAttribute;

        public ProvideEditorsBindingRedirectionAttribute(string assemblyName)
        {
