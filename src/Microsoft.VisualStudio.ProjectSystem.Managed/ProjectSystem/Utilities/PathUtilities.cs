...
namespace Microsoft.VisualStudio.ProjectSystem.Utilities
{
    ...
    internal static class PathUtilities
    {
        ...
        {
            Requires.Range(!IsUnixLikePlatform, nameof(path));
        ...
        {
            Requires.Range(IsAbsolute(root), nameof(root));
        ...
        {
            Requires.NotNullOrEmpty(root, nameof(root));
        ...
        {
            Requires.NotNull(assemblyDisplayNameOrPath, nameof(assemblyDisplayNameOrPath));
