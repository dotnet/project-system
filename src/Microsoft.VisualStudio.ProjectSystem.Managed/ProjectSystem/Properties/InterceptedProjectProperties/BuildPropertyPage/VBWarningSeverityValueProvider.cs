...
internal sealed class VBWarningSeverityValueProvider : InterceptingPropertyValueProviderBase
{
    ...
    {
        return IsValueDefinedInContextMsBuildPropertiesAsync(defaultProperties, new [] { WarningSeverityPropertyName, WarningLevelPropertyName, TreatWarningsAsErrorsPropertyName });
    }
