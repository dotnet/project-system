...
#pragma warning restore CA3075 // Insecure DTD processing in XML
        ...
        {
            userFileCommandArgs ??= new();
            userFileCommandArgs.Add(xmlNodeList[i].InnerText);
    ...
    {
        if (writableLaunchSettings is null || writableLaunchSettings.ActiveProfile is null || userFileCommandArgs is null)
        {
            return false;
        }
