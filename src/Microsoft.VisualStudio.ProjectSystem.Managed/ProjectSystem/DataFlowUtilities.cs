...
namespace Microsoft.VisualStudio.ProjectSystem
{
    ...
    internal static class DataflowUtilities
    {
        ...
        ///     <paramref name="transform"/> is <see langword="null"/>.
        /// </exception>
        public static DisposableValue<ISourceBlock<TOut>> TransformMany<TInput, TOut>(
            this ISourceBlock<IProjectVersionedValue<TInput>> source,
            Func<IProjectVersionedValue<TInput>, IEnumerable<TOut>> transform)
        {
            ...
            IPropagatorBlock<IProjectVersionedValue<TInput>, TOut> transformBlock = DataflowBlockSlim.CreateTransformManyBlock(transform);
