...
namespace Microsoft.VisualStudio.ProjectSystem.LanguageServices
{
    ...
    internal class WorkspaceProjectContextHostInitiator
    {
        ...
        {
            _languageServiceTelemetryService.PostLanguageServiceEvent(new LanguageServiceTelemetryEvent(LanguageServiceOperationNames.WorkspaceProjectContextHostInitiatorInitialized));
