...
namespace Microsoft.VisualStudio.ProjectSystem.LanguageServices
{
    ...
    internal class ActiveWorkspaceProjectContextHost : IActiveWorkspaceProjectContextHost
    {
        ...
        {
            _languageServiceTelemetryService.PostLanguageServiceEvent(new LanguageServiceTelemetryEvent(LanguageServiceOperationNames.ActiveWorkspaceProjectContextHostPublishing));
