...
namespace Microsoft.VisualStudio.ProjectSystem
{
    ...
    internal interface IProjectAccessor
    {
        ...
        ///     NOTE: To avoid deadlocks, do not call arbitrary services or asynchronous code within <paramref name="action"/>.
        /// </remarks>
        Task OpenProjectXmlForWriteAsync(UnconfiguredProject project, Func<ProjectRootElement, Task> action, CancellationToken cancellationToken = default);
        ...
        ///     NOTE: To avoid deadlocks, do not call arbitrary services or asynchronous code within <paramref name="action"/>.
        /// </remarks>
        Task<TResult> OpenProjectForReadAsync<TResult>(ConfiguredProject project, Func<Project, Task<TResult>> action, CancellationToken cancellationToken = default);
        ...
        ///     NOTE: To avoid deadlocks, do not call arbitrary services or asynchronous code within <paramref name="action"/>.
        /// </remarks>
        Task OpenProjectForUpgradeableReadAsync(ConfiguredProject project, Func<Project, Task> action, CancellationToken cancellationToken = default);
