...
curl -o %~dp0.releases/.releases.json https://builds.dotnet.microsoft.com/dotnet/release-metadata/releases-index.json 
ECHO Saved as %~dp0.releases/.releases.json
