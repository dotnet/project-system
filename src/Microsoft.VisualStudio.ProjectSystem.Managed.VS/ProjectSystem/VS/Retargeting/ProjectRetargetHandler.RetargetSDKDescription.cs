...
internal partial class ProjectRetargetHandler
{
    ...
    {
        internal static RetargetSDKDescription Create(string sdkVersion, Architecture arch)
        {
            return new RetargetSDKDescription(sdkVersion, arch);
        }

        private RetargetSDKDescription(string sdkVersion, Architecture arch) : base(
