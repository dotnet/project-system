...
namespace Microsoft.VisualStudio.ProjectSystem.VS
{
    ...
    internal sealed class DotNetCoreProjectCompatibilityDetector : IDotNetCoreProjectCompatibilityDetector, IVsSolutionEvents, IVsSolutionLoadEvents, IDisposable
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            if (ErrorHandler.Succeeded(solution.GetProperty((int)__VSPROPID4.VSPROPID_IsSolutionFullyLoaded, out object objIsFullyLoaded)) &&
                objIsFullyLoaded is bool isFullyLoaded &&
                isFullyLoaded)
            {
