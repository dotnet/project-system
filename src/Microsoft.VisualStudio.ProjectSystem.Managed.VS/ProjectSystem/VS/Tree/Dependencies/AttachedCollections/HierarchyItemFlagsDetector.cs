...
namespace Microsoft.VisualStudio.ProjectSystem.VS.Tree.Dependencies.AttachedCollections
{
    ...
    /// </remarks>
    internal readonly struct HierarchyItemFlagsDetector
    {
        private readonly Regex? _regex;

        public HierarchyItemFlagsDetector(ProjectTreeFlags flags, RegexOptions options = RegexOptions.Compiled)
        {
            switch (flags.Count)
            {
                case 0:
        ...
        public bool Matches(IVsHierarchyItem item)
        {
            ...
            if (item.TryGetFlagsString(out string? value))
            {
