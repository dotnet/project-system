...
namespace Microsoft.VisualStudio.ProjectSystem.VS.Tree.Dependencies
{
    ...
    {
        public static readonly GraphNodeIdName ProviderTypeGraphNodeValueName =
            GraphNodeIdName.Get("Microsoft.VisualStudio.ProjectSystem.VS.Tree.ProviderType", 
                null, typeof(string), true);

        public static readonly GraphNodeIdName DependencyUniqueId =
            GraphNodeIdName.Get("Microsoft.VisualStudio.ProjectSystem.VS.Tree.DependencyUniqueId",
                null, typeof(string), true);
