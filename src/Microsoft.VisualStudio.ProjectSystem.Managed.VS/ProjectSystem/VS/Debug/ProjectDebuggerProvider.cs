...
namespace Microsoft.VisualStudio.ProjectSystem.VS.Debug
{
    ...
    internal class ProjectDebuggerProvider : DebugLaunchProviderBase, IDeployedProjectItemMappingProvider
    {
        ...
        public ProjectDebuggerProvider(ConfiguredProject configuredProject, ILaunchSettingsProvider launchSettingsProvider, VsService<SVsShellDebugger, IVsDebugger4> vsDebuggerService)
        ...
        public ProjectDebuggerProvider(ConfiguredProject configuredProject, ILaunchSettingsProvider launchSettingsProvider,
                                       ...
                                       VsService<SVsShellDebugger, IVsDebugger4> vsDebuggerService)
            : base(configuredProject)
        {
        ...
        private readonly VsService<SVsShellDebugger, IVsDebugger4> _vsDebuggerService;
