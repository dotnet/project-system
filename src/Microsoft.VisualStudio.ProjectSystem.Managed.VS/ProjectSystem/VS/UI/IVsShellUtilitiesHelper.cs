...
namespace Microsoft.VisualStudio.ProjectSystem.VS.UI
{
    internal interface IVsShellUtilitiesHelper
    {
        ...
        /// </summary>
        Task<Version> GetVSVersionAsync(VsService<SVsAppId, IVsAppId> vsAppIdService);

        Task<string> GetLocalAppDataFolderAsync(VsService<SVsShell, IVsShell> vsShellService);
    }
}
