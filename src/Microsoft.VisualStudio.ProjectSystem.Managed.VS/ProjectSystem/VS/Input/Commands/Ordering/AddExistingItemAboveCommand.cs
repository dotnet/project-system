...
namespace Microsoft.VisualStudio.ProjectSystem.VS.Input.Commands.Ordering
{
    ...
    internal class AddExistingItemAboveCommand : AbstractAddItemCommand
    {
        ...
        public AddExistingItemAboveCommand(IPhysicalProjectTree projectTree, IUnconfiguredProjectVsServices projectVsServices, SVsServiceProvider serviceProvider, IProjectAccessor accessor) : base(projectTree, projectVsServices, serviceProvider, accessor)
        {
        }
