...
namespace Microsoft.VisualStudio.ProjectSystem.VS.Input.Commands
{
    ...
    internal class VS2kAddItemCommandHandler : AbstractAddItemCommandHandler
    {
        ...
        public VS2kAddItemCommandHandler(IPhysicalProjectTree projectTree, IUnconfiguredProjectVsServices projectVsServices, IVsUIService<IVsAddProjectItemDlg> addItemDialog, IVsService<SVsShell, IVsShell> vsShell)
