...
namespace Microsoft.VisualStudio.ProjectSystem.VS.Properties
{
    ...
    internal static class CSharpProjectDesignerPage
    {
        ...
        public static readonly ProjectDesignerPageMetadata Debug = new ProjectDesignerPageMetadata(new Guid("{0273C280-1882-4ED0-9308-52914672E3AA}"), pageOrder: 4, hasConfigurationCondition: true);
