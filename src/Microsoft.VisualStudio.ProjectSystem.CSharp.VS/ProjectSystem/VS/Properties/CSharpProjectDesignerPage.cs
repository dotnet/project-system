...
namespace Microsoft.VisualStudio.ProjectSystem.VS.Properties
{
    ...
    internal static class CSharpProjectDesignerPage
    {
        ...
        public static readonly ProjectDesignerPageMetadata ReferencePaths = new ProjectDesignerPageMetadata(new Guid("{031911C8-6148-4e25-B1B1-44BCA9A0C45C}"), pageOrder: 4, hasConfigurationCondition: false);
        public static readonly ProjectDesignerPageMetadata Signing = new ProjectDesignerPageMetadata(new Guid("{F8D6553F-F752-4DBF-ACB6-F291B744A792}"), pageOrder: 5, hasConfigurationCondition: false);
    }
}
