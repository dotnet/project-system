...
Namespace Microsoft.VisualStudio.Editors.ApplicationDesigner
    ...
    Public Class ApplicationDesignerPanel
        ...
        Public Sub New(View As ApplicationDesignerView, Hierarchy As IVsHierarchy, ItemId As UInteger)
            ...
            InitializeComponent()
            Me._pageNameLabel.Visible = Common.IsScreenReaderRunning()
...
#End If
        ...
        Public Property TabTitle() As String
            ...
            Set(value As String)
                ...
                Else
                    Me.Text = SR.GetString(My.Resources.Microsoft_VisualStudio_AppDesigner_Designer.APPDES_PageName, value)
                End If
...
#End Region
        ...
        Private Sub InitializeComponent()
            ...
            'PageHostingPanel
            '
            Me._pageHostingPanel.Dock = DockStyle.Fill
            ...
            'PageNameLabel
            '
            Me._pageNameLabel.Anchor = AnchorStyles.Left
