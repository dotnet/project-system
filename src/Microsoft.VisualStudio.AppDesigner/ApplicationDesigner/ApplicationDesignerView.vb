...
#End If
        ...
        Public Function DsMsgBox( Message As String, _
            ...
            Return AppDesDesignerFramework.DesignerMessageBox.Show(_serviceProvider, Message, _messageBoxCaption, _
        ...
        ''' <param name="HelpLink">The help link</param>
        ''' <remarks></remarks>
        Public Sub DsMsgBox( ex As Exception, _
...
#Region "SQM helpers"
        ...
        ''' <remarks></remarks>
        Friend Sub LogSqmDatapoint( dataPointId As UInteger,  value As UInteger)
        ...
        ''' <param name="value"></param>
        ''' <remarks></remarks>
        Friend Sub IncrementSqmDatapoint( dataPointId As UInteger, Optional  value As UInteger = 1)
            If VsLog IsNot Nothing Then
        ...
        ''' <param name="value"></param>
        ''' <remarks></remarks>
        Friend Sub AddSqmItemToStream( dataPointId As UInteger, Optional  value As UInteger = 1)
            If VsLog IsNot Nothing Then
