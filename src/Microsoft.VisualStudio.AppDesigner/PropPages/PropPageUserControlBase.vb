...
#Region " Windows Form Designer generated code "
        ...
        Protected Sub New(serviceProvider As ServiceProvider)
            ...
            Text = My.Resources.Microsoft_VisualStudio_AppDesigner_Designer.PPG_PropertyPageControlName
        ...
        Private Function ProcessDelayValidationQueue(items As ListDictionary, canThrow As Boolean) As Boolean
            ...
            Try
                ...
                If finalResult <> ValidationResult.Succeeded Then
                    ...
                    Else
                        Dim caption As String = My.Resources.Microsoft_VisualStudio_AppDesigner_Designer.APPDES_Title
                        ...
                        Catch ex As ProjectReloadedException
                            ...
                            For Each cd As PropertyControlData In ControlData
                                If cd IsNot _controlData AndAlso cd.IsDirty Then
                                    ShowErrorMessage(My.Resources.Microsoft_VisualStudio_AppDesigner_Designer.PPG_ProjectReloadedSomePropertiesMayNotHaveBeenSet)
                                    Exit For
                                End If
                            Next
...
#End Region
        ...
        Protected Function ShowChildPage(Title As String, PageType As Type, F1Keyword As String) As DialogResult
            ...
            If _childPages.ContainsKey(PageType) Then
                ...
                Catch ex As Exception When Common.ReportWithoutCrash(ex, My.Resources.Microsoft_VisualStudio_AppDesigner_Designer.APPDES_ErrorLoadingPropPage, NameOf(PropPageUserControlBase))
                    ShowErrorMessage(My.Resources.Microsoft_VisualStudio_AppDesigner_Designer.APPDES_ErrorLoadingPropPage & vbCrLf & Common.DebugMessageFromException(ex))
        ...
        Protected Function GetFileViaBrowse(InitialDirectory As String, ByRef NewValue As String, Filter As String) As Boolean
            Dim fileNames As ArrayList = Common.GetFilesViaBrowse(ServiceProvider, Handle, InitialDirectory, My.Resources.Microsoft_VisualStudio_AppDesigner_Designer.PPG_SelectFileTitle, Filter, 0, False)
