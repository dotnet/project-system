...
#End Region
        ...
        Private Sub UpdateDropdownEntries()
            ...
            If ConfigNames.Length > 1 Then
                ...
                _configurationDropdownEntries(ConfigIndex) = New DropdownItem(My.Resources.Microsoft_VisualStudio_AppDesigner_Designer.PPG_AllConfigurations, SelectionTypes.All)
                ConfigIndex += 1
            End If
            ...
            If PlatformNames.Length > 1 Then
                ...
                _platformDropdownEntries(PlatformIndex) = New DropdownItem(My.Resources.Microsoft_VisualStudio_AppDesigner_Designer.PPG_AllPlatforms, SelectionTypes.All)
                PlatformIndex += 1
            End If
...
#End If
        ...
        ''' <remarks></remarks>
        Private Function FindItemToSelect(ExistingItems() As DropdownItem, CurrentIndex As Integer, DesiredName As String, DesiredSelectionType As SelectionTypes, _
            PreferExactMatch As Boolean _
        ) As Integer
