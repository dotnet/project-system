        ...
        Private ReadOnly Property VsTextStream() As IVsTextBuffer
            Get
                ...
                If localRegistry Is Nothing Then
                    Throw New COMException(My.Resources.Microsoft_VisualStudio_AppDesigner_Designer.DFX_NoLocalRegistry, NativeMethods.E_FAIL)
                End If
                ...
                Catch ex As Exception
                    Throw New COMException(My.Resources.Microsoft_VisualStudio_AppDesigner_Designer.DFX_UnableCreateTextBuffer, NativeMethods.E_FAIL)
                End Try
                Return _vsTextBuffer
            End Get
        End Property
