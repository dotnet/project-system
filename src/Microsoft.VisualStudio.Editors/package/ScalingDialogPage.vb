...
Namespace Microsoft.VisualStudio.Editors.Package
    ...
    Public MustInherit Class ScalingDialogPage
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Private Function AdjustScale(scale As Single) As Single
            Return scale
        End Function
        ...
        ''' <param name="e"></param>
        ''' <remarks></remarks>
        Protected Overrides Sub OnActivate(e As System.ComponentModel.CancelEventArgs)
        ...
        ''' </remarks>
        Protected Overridable Function InheritsFont(ctrl As Control) As Boolean
            Return True
        End Function
        ...
        Private Sub AttachHandlers(ctrl As Control)
