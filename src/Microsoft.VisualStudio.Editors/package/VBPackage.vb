...
#Region "SQM helpers"
        ...
        ''' <remarks></remarks>
        Friend Shared Sub LogSqmDatapoint( dataPointId As UInteger,  value As UInteger)
        ...
        ''' <param name="value"></param>
        ''' <remarks></remarks>
        Friend Shared Sub IncrementSqmDatapoint( dataPointId As UInteger, Optional  value As UInteger = 1)
            If VsLog IsNot Nothing Then
        ...
        ''' <param name="value"></param>
        ''' <remarks></remarks>
        Public Shared Sub AddSqmItemToStream( dataPointId As UInteger, Optional  value As UInteger = 1)
            If VsLog IsNot Nothing Then
