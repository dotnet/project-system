...
Namespace Microsoft.VisualStudio.Editors.Package
    ...
    Friend Class InternalException
        ...
        Public Sub New()
            Me.New(SR.GetString(My.Resources.Microsoft_VisualStudio_Editors_Designer.RSE_Err_InternalException), Nothing)
        End Sub
        ...
        Public Sub New(InnerException As Exception)
            Me.New(SR.GetString(My.Resources.Microsoft_VisualStudio_Editors_Designer.RSE_Err_InternalException), InnerException)
        End Sub
