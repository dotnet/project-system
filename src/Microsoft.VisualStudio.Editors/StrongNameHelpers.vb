...
Namespace Microsoft.Runtime.Hosting
    Friend Class StrongNameHelpers
        ...
        Private Shared ReadOnly Property StrongName As IClrStrongName
            Get
                If (StrongNameHelpers.s_StrongName Is Nothing) Then StrongNameHelpers.s_StrongName = DirectCast(RuntimeEnvironment.GetRuntimeInterfaceAsObject(New Guid("B79B0ACD-F5CD-409b-B5A5-A16244610B92"), New Guid("9FD93CCF-3280-4391-B3A9-96E1CDE77C8D")), IClrStrongName)
