...
Namespace My.Resources
    ...
    Public Class GeneralOptionPageResources
        ...
        Public Shared ReadOnly Property General_DoubleClickOpenProjectFile() As String
            Get
                Return ResourceManager.GetString("General_DoubleClickOpenProjectFile", resourceCulture)
            End Get
        End Property
        
        '''<summary>
        '''  Looks up a localized string similar to Don&apos;t call _MSBuild if a project appears to be up to date.
        '''</summary>
        ...
        '''<summary>
        '''  Looks up a localized string similar to Use _previews of the .NET Core SDK.
        '''</summary>
