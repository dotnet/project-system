...
Namespace My.Resources
    ...
    Public Class GeneralOptionPageResources
        ...
        '''<summary>
        '''  Looks up a localized string similar to Reduces build times by limiting the build of multi-targeting projects to a single target framework where possible..
        '''</summary>
