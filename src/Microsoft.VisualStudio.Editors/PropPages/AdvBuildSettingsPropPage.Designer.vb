...
Namespace Microsoft.VisualStudio.Editors.PropertyPages
    Partial Class AdvBuildSettingsPropPage
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.cboLanguageVersion = new PropPages.AccessibleComboBox()
            Me.cboReportCompilerErrors = new PropPages.AccessibleComboBox()
            Me.lblDebugInfo = New System.Windows.Forms.Label()
            Me.cboDebugInfo = new PropPages.AccessibleComboBox()
            Me.lblFileAlignment = New System.Windows.Forms.Label()
            Me.cboFileAlignment = new PropPages.AccessibleComboBox()
