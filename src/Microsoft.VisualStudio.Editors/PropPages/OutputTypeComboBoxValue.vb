        ...
        Public Sub New(value As UInteger)
            ...
            Select Case _value
                Case CUInt(prjOutputTypeEx.prjOutputTypeEx_WinExe)
                    _displayName = SR.GetString(My.Resources.Microsoft_VisualStudio_Editors_Designer.PPG_WindowsApp)

                Case CUInt(prjOutputTypeEx.prjOutputTypeEx_Exe)
                    _displayName = SR.GetString(My.Resources.Microsoft_VisualStudio_Editors_Designer.PPG_CommandLineApp)

                Case CUInt(prjOutputTypeEx.prjOutputTypeEx_Library)
                    _displayName = SR.GetString(My.Resources.Microsoft_VisualStudio_Editors_Designer.PPG_WindowsClassLib)

                Case CUInt(prjOutputTypeEx.prjOutputTypeEx_WinMDObj)
                    _displayName = SR.GetString(My.Resources.Microsoft_VisualStudio_Editors_Designer.PPG_WinMDObj)

                Case CUInt(prjOutputTypeEx.prjOutputTypeEx_AppContainerExe)
                    _displayName = SR.GetString(My.Resources.Microsoft_VisualStudio_Editors_Designer.PPG_AppContainerExe)
