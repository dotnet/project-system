        ...
        Protected Overrides ReadOnly Property ControlData() As PropertyControlData()
            Get
                If m_ControlData Is Nothing Then
                    ...
                    data.DisplayPropertyName = SR.GetString(My.Resources.Microsoft_VisualStudio_Editors_Designer.PPG_Property_AssemblyGuid)
                    datalist.Add(data)
        ...
        Protected Overrides Function ValidateProperty(controlData As PropertyControlData, ByRef message As String, ByRef returnControl As Control) As ValidationResult
            If controlData.FormControl Is GuidTextBox Then
                ...
                Catch e As FormatException
                    message = SR.GetString(My.Resources.Microsoft_VisualStudio_Editors_Designer.PPG_Application_BadGuid)
