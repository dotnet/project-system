...
Namespace Microsoft.VisualStudio.Editors.PropertyPages
    ...
    Friend Class PackagePropPage
        ...
        Private Sub ValidatePackageVersion(ByRef Version As String)
            ValidateVersion(PackageVersion, s_maxFileVersionPartValue, My.Resources.Microsoft_VisualStudio_Editors_Designer.PPG_Property_PackageVersion, False, Version)
        End Sub
