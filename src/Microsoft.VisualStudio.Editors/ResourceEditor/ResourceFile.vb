        ...
        Protected Sub Dispose(Disposing As Boolean)
            If Disposing Then
                ...
                If _resourcesHash IsNot Nothing Then
                    ...
                    For Each resource In _resourcesHash.Values
                        resource.Dispose()
                    Next
...
#Region "Properties"
        ...
        ''' <value></value>
        ''' <remarks></remarks>
        Friend ReadOnly Property ResourcesHashTable() As Dictionary(Of String, Resource)
            Get
...
#End If
        ...
        Private Sub ComponentChangeService_ComponentAdded(sender As Object, e As ComponentEventArgs) Handles _componentChangeService.ComponentAdded
            ...
            _resourcesHash.Add(Resource.Name, Resource)
        ...
        Private Sub ComponentChangeService_ComponentRemoved(sender As Object, e As ComponentEventArgs) Handles _componentChangeService.ComponentRemoved
            ...
            _resourcesHash.Remove(Resource.Name)
