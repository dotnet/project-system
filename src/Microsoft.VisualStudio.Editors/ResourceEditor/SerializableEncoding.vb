    ...
    Friend NotInheritable Class SerializableEncoding
        ...
        Public Function DisplayName() As String
            If _encoding IsNot Nothing Then
                Return My.Resources.Designer.GetString(My.Resources.Designer.RSE_EncodingDisplayName, _encoding.EncodingName, CStr(_encoding.CodePage))
            Else
                'Default
                Return My.Resources.Designer.RSE_DefaultEncoding
            End If
        End Function
