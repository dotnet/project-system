...
|[16.0](https://github.com/dotnet/project-system/milestone/12)|[16.0.x](https://github.com/dotnet/project-system/tree/dev16.0.x)|Visual Studio 2019|This release is considered done, and only impactful bugs, crashes and hangs that block _major_ and _minor_ scenarios will be taken.
