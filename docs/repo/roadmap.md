...
|[15.5](https://github.com/dotnet/project-system/milestone/16)|[15.6](https://github.com/dotnet/roslyn-project-system/tree/dev15.6)|Impactful bugs, crashes and hangs that block major and minor scenarios.
