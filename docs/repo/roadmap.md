...
|[15.3 Preview](https://github.com/dotnet/roslyn-project-system/milestone/15)|[master](https://github.com/dotnet/roslyn-project-system/tree/dev15.3.x)|Support for .NET Core 2.0, .NET Standard 2.0, and other bugs fixes related to .NET Core tooling that do not make above releases.
